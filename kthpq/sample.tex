...
\begin{frame}{Dual network approach I}
	...
	Highly dependent on governing dynamics from $c_{\text{cont}} = \dot{x}-Ax$\\
\end{frame}
...
\todo{Jetzt hier meine versuche mit 2 netzten, 2 netze mit feedback, 1 netz, 1 netz mit feedback etc und was/warum es nicht geklappt hat}
